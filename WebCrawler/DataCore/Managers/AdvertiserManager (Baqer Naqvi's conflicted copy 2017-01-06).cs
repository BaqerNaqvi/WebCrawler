    ...
    public class AdvertiserManager
    {
        ...
        internal BillingContainer GetBillingHistory(int vendorId)
        {
            var billingModel = new BillingContainer
            {
                ...
                {
                    Id = 1, InvoiceNo = "463946",TranslationId = "5485", TransDateTimeStr=DateTime.Now.AddMonths(-1).Date.ToShortDateString(), Amount = 125
                }, new BillingHistory_Temp
                {
                    Id = 2, TranslationId = "4232",  InvoiceNo = "876538",TransDateTimeStr=(DateTime.Now).AddMonths(-2).Date.ToShortDateString(), Amount = 350
                } , new BillingHistory_Temp
                {
                    Id = 2, TranslationId = "6422", InvoiceNo = "878301", TransDateTimeStr=DateTime.Now.AddMonths(-3).Date.ToShortDateString(), Amount = 50
                } }
