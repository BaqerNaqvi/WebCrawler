...
namespace WebCrawler.Models.PayPal
{
    public class RequestFlow
    {
        ...
        public void AddNewRequest(string title, IPayPalSerializableObject requestObject = null, string description = "")
        {
            ...
            {
                Request = requestObject == null ? string.Empty : WebCrawler.Models.PayPal.Common.FormatJsonString(requestObject.ConvertToJson()),
                Title = title,
        ...
        public void RecordResponse(IPayPalSerializableObject responseObject)
        {
            ...
            {
                this.Items.Last().Response = WebCrawler.Models.PayPal.Common.FormatJsonString(responseObject.ConvertToJson());
            }
        }
