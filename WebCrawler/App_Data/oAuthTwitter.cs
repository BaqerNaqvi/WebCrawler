...
namespace oAuthExample
{
    public class oAuthTwitter : OAuthBase
    {
        ...
        private string _callBackUrl = "http://staging.dentalvalet.com/pages/index.aspx";

        private string _consumerKey = "TUD7cxWcnHY5X11ElsI8SDskB";
        private string _consumerSecret = "JyNOvwvCRuSgu1AHdyhlp1xptBhaLzA3tt7AT6Og4BgcjkUxvo";
        private string _oauthVerifier = "";
        private string _token = "477693288-7qaphs7Tf04y6So80Z6Pfv4DLtPAiLLVW3dWZZKT";
        private string _tokenSecret = "Gak46eRO5krpVD5DJxARwOY1Anoqed34B8Xjy3vsDaYTX";
