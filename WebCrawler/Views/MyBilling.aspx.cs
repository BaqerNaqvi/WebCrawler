...
{
    public partial class MyBilling :  BaseSamplePage
    {
        ...
        protected override void RunSample()
        {
            ...
            if (string.IsNullOrEmpty(payerId))
            {
                ...
                var baseURI = Request.Url.Scheme + "://" + Request.Url.Authority + "/Views/MyBilling.aspx?";
                ...
                {
                    currency = "USD",
                    total = "95.00", // Total must be equal to sum of shipping, tax and subtotal.
                    details = details
                };
                ...
                transactionList.Add(new Transaction()
                {
                    ...
                    invoice_number = Models.PayPal.Common.GetRandomInvoiceNumber(),
                    amount = amount,
                    item_list = itemList
                });
            ...
            else
            {
                ...
                paymentduespan.InnerHtml = "0";
                paymentduespan.Disabled = true;
