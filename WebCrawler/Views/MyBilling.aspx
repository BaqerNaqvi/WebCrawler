                ...
                success: function (response) {
                    ...
                    if (response.BillingHistory != null) {
                        ...
                        for (var i = 0; i < response.BillingHistory.length; i++) {
                            html = html + " <tr><th scope='row'>" + response.BillingHistory[i].TranslationId + "</th><td>" + response.BillingHistory[i].TransDateTimeStr +
                        ...
                        if ((url.indexOf("paymentId") !== -1)) {
                            ...
                            var temp = " <tr><th scope='row'>" + 3696 + "</th><td>" + "12/28/2016" +
                                "</td><td>" + 95 + "</td></tr>";
                    ...
                    <table class="table table-striped">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                      <asp:Button ID="Button1"  style="float: right;" class="btn btn-primary" runat="server" Text="Click Me" OnClick="Button1_Click" />
