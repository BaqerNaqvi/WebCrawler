<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvertiserRegistration.aspx.cs" Inherits="WebCrawler.Views.AdvertiserRegistration" %>
      ...
      <div class="login">
          ...
          <h2 class="login-header">Sign up</h2>
           <div class="login-container">
               ...
               <p><input type="submit" id="fetch1" onclick="AddAdver()" value="Get Started" /></p>
           </div>
