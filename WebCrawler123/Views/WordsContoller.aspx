<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WordsContoller.aspx.cs" MasterPageFile="~/MasterPages/Site1.master" Inherits="WebCrawler.Views.WordsContoller" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        function AddWordExWord(table) {
            ...
            if (word == "") {
                document.getElementById('fetch1').innerHTML = "Please enter valid word";
                return false;
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById('fetch1').innerHTML = "Add words you want to remove from crawl result";
                },
                statusCode: {
                    404: function () {
                        alert('Failed');
        ...
        function RemoveExWord(id) {
            ...
            document.getElementById('fetch1').innerHTML = "Removing Word. Please wait...";
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //debugger;
                    document.getElementById('fetch1').innerHTML = "Add words you want to include in crawl result";
                },
                statusCode: {
                    404: function () {
                        alert('Failed');
        ...
        function LoadExWord() {
            ...
            document.getElementById('fetch1').innerHTML = "Loading. Please wait...";
            $.ajax({
    ...
    <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb" style="text-align:right;">
                        ...
                        <li class="active">
                            <button type="button" id="urlSubmit"  class="btn btn-sm btn-primary" onclick="AddWord(1)" >Add Word</button>
                        </li>
