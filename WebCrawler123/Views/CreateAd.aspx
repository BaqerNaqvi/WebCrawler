<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateAd.aspx.cs" MasterPageFile="~/MasterPages/VendorDashboard.master" Inherits="WebCrawler.Views.CreateAd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function cancelAd() {
            window.location = "VendorDashboard.aspx";
        }
    </script>
